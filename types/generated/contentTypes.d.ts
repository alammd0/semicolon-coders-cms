...
export interface ApiSubSectionSubSection extends Struct.CollectionTypeSchema {
  collectionName: 'sub_sections';
  info: {
    displayName: 'SubSection';
    pluralName: 'sub-sections';
    singularName: 'sub-section';
  };
  options: {
    draftAndPublish: true;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sub-section.sub-section': ApiSubSectionSubSection;
